...
# Ensure there are no missing dates: fill forward and backward as needed
df['formatted_date'] = df['formatted_date'].ffill().bfill()

# Extract the minimum and maximum dates from the formatted_date column
