...
######################################################################
# batch to process all df_cur_year with AI model
######################################################################
# to compare current metrics with metrics using the model 

st.text("New data batch test")
...
final_result_df = predict_batch(df_cur_year, batch_size=20, sample_size=100)
