            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if predictions:
                        ...
                        # Get questions for all candidate HS codes with a single call.
                        question_payload = {"description": description, "top_hs06_codes": candidate_hs_codes}
                        with questions_col:
                            try:
                                ...
                                if q_response.status_code == 200:
                                    ...
                                    if questions:
                                        ...
                                        # Process the improvement request if the Q&A form was submitted.
                                        if improve_submitted:
                                            improve_payload = {"description": description, "qa_pairs": qa_pairs}
                                            try:
